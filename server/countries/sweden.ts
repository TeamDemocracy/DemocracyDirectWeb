...
export class Sweden{
    ...
    static name:string = 'sweden';
    //The url from which one would collect the simple description of a descision
    static commiteeReportsUrlBase:string = 'http://data.riksdagen.se/dokumentlista/?avd=dokument&doktyp=bet&Facets=2&a=s&sortorder=desc&sort=datum&utformat=json&sz=200'; // &p=30
    //The url base to use when constructing the dokuentstatus url
    static documentStatusUrlBase:string = 'http://data.riksdagen.se/dokumentstatus/'; // + docID.json
    //The url base for debatevideo
    static debateStreamUrlBase:string = 'http://www.riksdagen.se/Templates/Pages/embedwebtv.aspx?did='; // + docID (H310251 for example)
     ...
     */
     static synchronizeOurDataWithSource(){
